# sonarIssueScoring Individual Contributor License Agreement

Thank you for your interest in contributing to sonarIssueScoring ("We" or "Us").
...
"Contribution" means any work of authorship that is Submitted by You to Us in which You own or assert ownership of the Copyright. If You do not own the Copyright in the entire work of authorship, please follow the instructions in https://github.com/viadee/sonarIssueScoring/blob/master/CONTRIBUTING.md.
...
(d) You have followed the instructions in https://github.com/viadee/sonarIssueScoring/blob/master/CONTRIBUTING.md, if You do not own the Copyright in the entire work of authorship Submitted.
